...
// Retail Stores Landing Page - COMPLETE OPTIMIZED VERSION
        ...
        <div className="container-custom relative z-30 py-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-full mb-4 border border-white/30"
            >
              <FaStore className="text-white text-lg sm:text-xl" />
              <span className="text-sm sm:text-base font-semibold text-white">
                Trusted by 10+ Retail Stores in Punjab
              </span>
            </motion.div>
            ...
            >
              ...
              <motion.a
                href="https://wa.me/916283380110?text=Hi%2C%20I%20want%20an%20e-commerce%20website%20for%20my%20retail%20store"
                target="_blank"
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">10+ Retail Stores</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <ScrollReveal direction="up">
            <div className="text-center mb-8 ">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Beautiful Product Showcase for Your Store
              </h2>
              <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
                Display your products professionally and attract more customers online
              </p>
            </div>
          </ScrollReveal>
            ...
            {productShowcase.map((product, index) => (
              <ScrollReveal key={product.id} direction="up" delay={index * 0.1}>
                ...
                >
                  <Image
                    src={product.image}
                    alt={`${product.name} - E-commerce product showcase`}
                    fill
                    className="object-cover transform group-hover:scale-110 transition-transform duration-500"
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 via-gray-900/30 to-transparent opacity-80 group-hover:opacity-100 transition-opacity" />
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform z-10">
                    <div className="text-xs font-semibold text-cyan-300 mb-1">{product.category}</div>
      ...
      <section className="py-8 bg-white border-y border-gray-200">
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {[
              { value: 30, suffix: '%', label: 'Revenue Increase', icon: FaChartLine },
              { value: 20, suffix: '+', label: 'Daily Orders', icon: FaShoppingCart },
              { value: 1000, suffix: '+', label: 'Registered Customers', icon: FaUsers },
              { value: 60, suffix: '%', label: 'Repeat Purchases', icon: FaPercent },
            ].map((stat, index) => (
              <ScrollReveal key={index} direction="up" delay={index * 0.1}>
                ...
                >
                  <stat.icon className="text-3xl sm:text-4xl text-blue-600 mx-auto mb-2" />
        ...
        <div className="container-custom">
          <ScrollReveal direction="up">
            <div className="text-center mb-8">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
                Everything you need to sell online and compete with large platforms
              </p>
            </div>
          </ScrollReveal>
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="aspect-video bg-gradient-to-br from-blue-100 to-cyan-100 relative">
                  ...
                  <div className="absolute bottom-4 left-4 text-white z-10">
                    <FaShoppingCart className="text-4xl mb-2 drop-shadow-lg" />
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Smooth shopping experience with cart, wishlist, coupon codes. One-page checkout increases conversions by 15%.
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="aspect-video bg-gradient-to-br from-blue-100 to-cyan-100 relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/40 to-transparent" />
                  <div className="absolute bottom-4 left-4 text-white z-10">
                    <FaCreditCard className="text-4xl mb-2 drop-shadow-lg" />
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Accept payments via UPI, cards, net banking, and COD. Multiple payment options increase sales.
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="left">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="aspect-video bg-gradient-to-br from-blue-100 to-cyan-100 relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/40 to-transparent" />
                  <div className="absolute bottom-4 left-4 text-white z-10">
                    <FaTruck className="text-4xl mb-2 drop-shadow-lg" />
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Customers track orders in real-time. Automatic WhatsApp and email updates reduce "where is my order" calls.
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Real-time stock tracking, low stock alerts, automatic sold-out status. Never oversell products again.
                  </p>
                </div>
              </div>
            </ScrollReveal>
        ...
        <div className="container-custom">
          <ScrollReveal direction="up">
            <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Are You Missing Online Sales Opportunities?
              </h2>
              <p className="text-base sm:text-lg text-gray-600">
                Common challenges retail stores face without an e-commerce website
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {[
              ...
              'Limited to local area sales only?',
              'Want to sell 24/7 even when store is closed?',
              'Manual order taking consuming too much time?',
              'Need to reach customers across India?',
              'Missing out on festive season online sales?'
            ].map((pain, index) => (
              <ScrollReveal key={index} direction="up" delay={index * 0.1}>
                <motion.div
     ...
     {/* Features List - NEW */}
        ...
        <div className="container-custom">
          <ScrollReveal direction="up">
            <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12 lg:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Complete E-commerce Features for Retail Stores
              </h2>
              <p className="text-base sm:text-lg text-gray-600">
                Everything you need to start and grow your online retail business
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className="container-custom">
          <ScrollReveal direction="up">
            <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12">
              ...
              <p className="text-base sm:text-lg text-gray-600">
                Common questions about retail stores websites in Patiala
              </p>
            </div>
          </ScrollReveal>
      ...
      <section className="py-10 bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-600 text-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <ScrollReveal direction="up">
              <FaStore className="text-5xl sm:text-6xl mx-auto mb-6" />
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">
                Ready to Start Selling Online?
              </h2>
              <p className="text-lg sm:text-xl mb-8 sm:mb-10 text-blue-100">
                Professional e-commerce website starting at ₹{industryData.pricing.starting}. 
                Get 30% more revenue with our proven solution!
              </p>
