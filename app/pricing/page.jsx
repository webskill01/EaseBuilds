          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal direction="up">
              <div className="text-center mb-10">
                ...
                <p className="text-base sm:text-lg tone-muted">
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-1">
              {ALWAYS_INCLUDED.map((item, index) => (
                <ScrollReveal key={item} direction="up" delay={(index % 2) * 0.05}>
                  <div className="flex gap-3 items-start border-t border-white/10 py-3">
                    <span className="w-5 h-5 rounded-full bg-sky-400/15 text-sky-300 flex items-center justify-center flex-shrink-0 mt-0.5">
