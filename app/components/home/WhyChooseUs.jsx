...
import { FaCheckCircle, FaClock, FaUsers, FaHeadset, FaStar, FaAward, FaShieldAlt, FaRocket, FaPhone, FaWhatsapp, FaPhoneAlt } from 'react-icons/fa'
...
function BenefitCard({ benefit, index }) {
  ...
  return (
    <motion.div
      ...
      className="group flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl bg-white hover:shadow-lg transition-all duration-300 border border-gray-100"
    >
      {/* Icon */}
      <div 
        className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br ${benefit.gradient} rounded-xl flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-110`}
      >
        <benefit.icon className="text-xl sm:text-2xl text-white" />
      </div>
...
function StatCard({ stat, index }) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay: index * 0.1, duration: 0.4 }}
      className={`bg-gradient-to-br ${stat.gradient} rounded-2xl p-6 sm:p-7 lg:p-8 text-white shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 ${stat.delay ? 'mt-4 sm:mt-6 lg:mt-8' : ''}`}
    >
      {/* Icon */}
      <div className="mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="relative">
              ...
              {/* Floating badge */}
              <div className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full p-4 sm:p-5 shadow-2xl border-4 border-white">
              ...
              <div className="absolute -bottom-6 -left-6 hidden lg:block bg-white rounded-2xl p-4 shadow-xl border border-gray-100">
