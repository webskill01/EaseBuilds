...
export const siteConfig = {
  name: 'EaseBuilds',
  title: 'EaseBuilds | Best Website Development in Patiala',
  description: 'Web developer in Patiala Punjab. 15 projects shipped — 5 client websites and 10 automation systems in production. Websites from ₹2,999, delivered in 2-3 weeks.',
...
export const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Website development costs in Patiala Punjab India start from ₹2,999 for a basic 3-page website at EaseBuilds. Our packages include: Basic Plan (₹2,999 - 3 pages), Standard Plan (₹5,999 - 8 pages with blog), and Premium Plan (₹9,999 - unlimited pages with e-commerce). All packages include responsive design, SEO optimization, free maintenance, and fast delivery in 2-3 weeks.',
      },
    },
    {
      '@type': 'Question',
