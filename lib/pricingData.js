...
export const ALWAYS_INCLUDED = [
  ...
  'You own the code and the accounts, not me',
]
...
export const pricingFAQs = [
  ...
  },
  {
    ...
    answer: 'Yes. The code, the domain and every account are in your name. If you ever want to move to another developer, you leave with all of it and you do not need my permission.',
  },
]
